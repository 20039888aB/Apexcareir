...
import ApexCareIRMainPage from '../pages/ApexCareIRMainPage';
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="apexcareir-main" element={<Navigate to="/apexcareir-main/login" replace />} />
        <Route path="apexcareir-main/overview" element={<ApexCareIRMainPage />} />
      </Route>

      <Route element={<PublicOnlyRoute />}>
        <Route path="apexcareir-main/login" element={<LoginPage />} />
        <Route path="apexcareir-main/forgot-password" element={<ForgotPasswordPage />} />
        <Route path="apexcareir-main/reset-password" element={<ResetPasswordPage />} />
      </Route>

      <Route path="apexcareir-main/unauthorized" element={<UnauthorizedPage />} />

      <Route element={<ProtectedRoute />}>
        <Route path="apexcareir-main/app" element={<BusinessLayout />}>
